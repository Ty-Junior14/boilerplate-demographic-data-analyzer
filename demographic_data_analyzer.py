...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((df[df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])]['salary'] == '>50K').mean() * 100, 1)
    higher_education_rich = round(higher_education_rich, 1)
    
    lower_education_rich = round((df[~df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])]['salary'] == '>50K').mean() * 100, 1)
